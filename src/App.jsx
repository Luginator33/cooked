...
// Map URL paths to tab names and vice versa
...
function AppInner() {
  ...
  const effectiveInitialTab = pathTab || initialTab || "home";
...
// SSO callback component (needs to be outside router for redirect handling)
